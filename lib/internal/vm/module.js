...
class SourceTextModule extends Module {
  ...
  constructor(sourceText, options = {}) {
    ...
    // [[V8JERRY_CHANGE]]
    this.__statusOverride = undefined;
    this.__error = kNoError;

    this[kLink] = async (linker) => {
      // [[V8JERRY_CHANGE]]
      //this.#statusOverride = 'linking';
      this.__statusOverride = 'linking';
  ...
  get status() {
    ...
    if (this.__error !== kNoError) {
      return 'errored';
    }
    // [[V8JERRY_CHANGE]]
    //if (this.#statusOverride) {
    if (this.__statusOverride) {
      //return this.#statusOverride;
      return this.__statusOverride;
    }
    return super.status;
  }
